...
@interface GYJRenrenAuthorViewController () <UIWebViewDelegate>
{
    UIWebView *_webView;
...
@implementation GYJRenrenAuthorViewController
...
- (void)dialogDidSucceed:(NSURL *)url {
    ...
    [[GYJRenrenManager shareInstance] saveUserSessionInfo:responseDic];
