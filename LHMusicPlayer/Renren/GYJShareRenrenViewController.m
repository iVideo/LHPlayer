//
//  GYJIMShareRenrenViewController.m
//  GYJMusicPlayer
//
...
@interface GYJShareRenrenViewController ()<UITextViewDelegate,RORequestDelegate>
{
...
@implementation GYJShareRenrenViewController
...
- (void)shareButtonPressed {
	if(![[GYJRenrenManager shareInstance] isSessionValid]) {
        //推出登录界面
...
-(void)setGeneralRequestArgs: (RORequestParam *)inRequestParam{
    ...
    inRequestParam.sessionKey = [[GYJRenrenManager shareInstance] sessionKey];
    ...
    inRequestParam.sig = [self generateSig:[inRequestParam requestParamToDictionary] secretKey:[[GYJRenrenManager shareInstance] secret]];
}
