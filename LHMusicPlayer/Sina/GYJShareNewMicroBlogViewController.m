//
//  GYJNBShareNewMicroBlogViewController.m
//
//  Created by 郭亚娟 on 11-2-22.
...
@interface GYJShareNewMicroBlogViewController(PrivateMethod)

- (void)rotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation;

@end

@implementation GYJShareNewMicroBlogViewController
...
- (void)engineDidLogIn:(WBEngine *)engine withTokenString:(NSString*)tokenString{
    ...
    [[GYJActivityToast sharedActivityToast] startSpinWithInfo:[NSString stringWithFormat:@"认证成功"] withButtonTitle:nil careLandscope:NO];

    [_loginController dismissController];
}

- (void)engine:(WBEngine *)engine didFailToLogInWithError:(NSError *)error{
    [[GYJActivityToast sharedActivityToast] startSpinWithInfo:[NSString stringWithFormat:@"认证失败"] withButtonTitle:nil careLandscope:NO];
}
...
- (UIViewController *) newLoginController{
	_loginController = [[GYJOAuthLoginController alloc] initWithOA2Engine: _engine];
