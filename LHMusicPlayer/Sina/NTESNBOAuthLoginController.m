...
@implementation NTESNBOAuthLoginController
...
- (void)webView:(UIWebView *)webView didFailLoadWithError:(NSError *)error{
	...
	[[NTESActivityToast sharedActivityToast] stopSpinWithInfo:@"授权页面加载失败" withButtonTitle:@"确定"];
