//
//  NTESNBShareNewMicroBlogViewController.h
//  网易微博iPhone客户端
//
...
@interface NTESNBShareNewMicroBlogViewController : GYJMainBaseViewController <UITextViewDelegate,WBEngineDelegate> {
    ...
    BOOL shouldRotate;
    BOOL hasPhoto;
    NTESNBOAuthLoginController *_loginController;
